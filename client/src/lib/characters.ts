...
export const CHARACTERS: Character[] = [
  { id: 'tomas', label: 'Tomás', skin: '#f1c9a5', hair: '#5a3a22', hat: true },
  { id: 'lucia', label: 'Lucía', skin: '#c98f66', hair: '#2b2118', hat: false },
  { id: 'mateo', label: 'Mateo', skin: '#8d5a3b', hair: '#2b2118', hat: true },
  { id: 'sofia', label: 'Sofía', skin: '#f4d3b5', hair: '#a3402b', hat: false },
  { id: 'facundo', label: 'Facundo', skin: '#6b4226', hair: '#7a766e', hat: true, mustache: true },
  { id: 'ramon', label: 'Ramón', skin: '#e0ad7c', hair: '#7a4a20', hat: true, mustache: true },
  { id: 'rosario', label: 'Rosario', skin: '#a9714a', hair: '#241c12', hat: false, headscarf: true },
  { id: 'milagros', label: 'Milagros', skin: '#b97a4f', hair: '#3d2410', hat: false },
];
