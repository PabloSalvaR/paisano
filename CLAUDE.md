...
- **Polling que ahorra consultas:** pestaña oculta cada 20 s (al volver, enseguida), en tu turno cada 15 s (nada cambia hasta que actuás), pausa tras 5 min sin actividad (se retoma al tocar la pantalla), y se detiene solo al terminar la partida o ante 404/401 (cada consulta gasta un comando de Upstash; el plan Free da 500.000 al mes y 10 GB de ancho de banda: ~26 partidas de 4 personas por mes, ver `docs/multijugador.md`).
