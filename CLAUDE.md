...
- Verificado con Chrome (clics reales y `?debug`): construir con ✓/✕, dados y producción, 7 con descarte y robo, comercio con el banco y entre jugadores, bots, online, comprar y jugar cada carta, insignias, ancho de celular (en un marco de 390 px), destape y panel con las láminas nuevas.
